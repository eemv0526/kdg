...
import com.simplecoding.repositoryexam.mapper.list.LnvMapper;
...
@Service
public class LnvServiceImpl implements LnvService {
	
	
	@Autowired LnvMapper lnvMapper;

	@Override
	public List<?> selectLnvList(Criteria searchVO) throws Exception {
		// TODO Auto-generated method stub
		return lnvMapper.selectLnvList(searchVO);
	}

	@Override
	public int selectLnvListTotCnt(Criteria searchVO) {
		// TODO Auto-generated method stub
		return lnvMapper.selectLnvListTotCnt(searchVO);
	}

	@Override
	public void insertLnv(LnvVO lnvVO) throws Exception {
		// TODO Auto-generated method stub
		...
		lnvVO.setUuid(newUuid);
		lnvVO.setLnvUrl(fileDownloadURL);
		// 4) fileDbMapper의 insert 실행
		lnvMapper.insert(lnvVO);
	...
	@Override
	public LnvVO selectLnv(String uuid) throws Exception {
		
		LnvVO lnvVO = lnvMapper.selectLnv(uuid);
	...
	@Override
	public void deleteLnv(String uuid) throws Exception {
		// TODO Auto-generated method stub
		lnvMapper.delete(uuid);
		
	}

	@Override
	public void updateLnv(LnvVO lnvVO) throws Exception {
		// TODO Auto-generated method stub
		 lnvMapper.update(lnvVO);
	}
